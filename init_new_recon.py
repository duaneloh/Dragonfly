...
if __name__ == "__main__":
    ...
    parser.add_argument("-q", "--non_standard_quat", dest="sensible_quat_name", action="store_false", default=True)
    parser.add_argument("-l", "--link_to_parent_data", dest="link_to_parent_data", action="store_true", default=False)
