...
class Conversion_panel(QtWidgets.QWidget):
    ...
    def init_UI(self):
        ...
        self.r_min = QtWidgets.QLineEdit(self.parent.conv_params[0])
        ...
        hbox.addWidget(label)
        self.r_max = QtWidgets.QLineEdit(self.parent.conv_params[1])
        ...
        hbox.addWidget(label)
        self.delta_r = QtWidgets.QLineEdit(self.parent.conv_params[2])
        ...
        hbox.addWidget(label)
        self.delta_ang = QtWidgets.QLineEdit(self.parent.conv_params[3])
        ...
        self.method.addItem('raw_normed')
