...
class Conversion_panel(QtWidgets.QWidget):
    ...
    def init_UI(self):
        ...
        self.delta_r.returnPressed.connect(self.remake_converter)
        ...
        self.delta_ang.returnPressed.connect(self.remake_converter)
