...
fluence (photons/um$^2$)& $1\times10^{10}$\footnote{See \citeasnoun{Loh2013}.}    & $1\times10^{12}$ & $3.125\times10^{12}$ \\
resolution at edge (nm) & 2.45                & 0.56             & 2.5 \\
\hline
sample                  & KLH1\footnote{Keyhole Limpet Hemocyanin 1.}& TMV\footnote{Four-layer Tobacco Mosaic Virus.}& KLH1$^\ddagger$ \\
...
TODO: Describe how we know a reconstruction converges and monitor its progress. Describe how we nurse reconstructions to higher rotation group sampling. Describe how we guide a ``heating'' up of a beta parameter reconstruction.
...
\begin{figure}
\caption{A simulated reconstruction at the CXI endstation at LCLS (see Table \ref{table:simParams}).}
